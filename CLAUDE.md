...
**수정 내용**: `import hasClass from './hasClass';` → `import * as hasClass from './hasClass';`

**적용 파일**: `node_modules/.pnpm/dom-helpers@5.2.1/node_modules/dom-helpers/esm/addClass.js`
...
- **Double Submit Cookie Pattern** 사용 (세션 CSRF 토큰 ↔ HttpOnly 쿠키 CSRF 토큰 비교)
...
export class SessionService {
  ...
  invalidateSession(session: any, sessionId?: string): void {
    ...
    // 로그 기록
    this.logger.warn(`Session invalidated due to CSRF attack: ${sessionId || 'unknown'}`);
  }
