...
(
    ...
    status                  varchar(16)                         not null comment '변경된 상태 (''READY'', ''CONSULTING'', ''END'')',
    created_at              timestamp default CURRENT_TIMESTAMP null,
    consultationId          bigint                              null,
    check (`status` in (_utf8mb4\'READY\',_utf8mb4\'CONSULTING\',_utf8mb4\'END\'))
);
...
(
    ...
    status                 varchar(16) default 'READY'           not null comment '상담실 상태: READY, CONSULTING, END',
...
(
    ...
    type        varchar(16)                          not null comment '시설 유형: CONSTRUCTION, MACHINE, ELECTRICITY',
    image_url   varchar(255)                         null comment '시설 이미지 URL',
    check (`type` in (_utf8mb4\'CONSTRUCTION\',_utf8mb4\'MACHINE\',_utf8mb4\'ELECTRICITY\'))
);
...
(
    id           bigint auto_increment comment '로그 고유 ID'
        primary key,
    action_type  varchar(16)  not null comment '이벤트 유형 (VISITOR_ENTER, VISITOR_EXIT, MOVE, POP_OPEN, POP_CLOSE)',
    ...
    ip_address   varchar(45)  null comment 'IP 주소',
    check (`action_type` in (_utf8mb4\'VISITOR_ENTER\',_utf8mb4\'VISITOR_EXIT\',_utf8mb4\'MOVE\',_utf8mb4\'POP_OPEN\',_utf8mb4\'POP_CLOSE\'))
)
...
create index phone_verifications_pk_hash
    on lh_cs__phone_verifications (phone_hash);
...
(
    ...
    status                  varchar(16) default 'READY' null comment 'READY, CONSULTING, END',
...
(
    ...
    role                          varchar(16) default 'USER'               null comment '사용자 역할 (SUPER_ADMIN, ADMIN, CONSULTANT, USER, VISITOR)',
    status                        varchar(32) default 'ACTIVE'             not null,
    approval_status               varchar(16) default 'PENDING'            null comment '사용자 승인 상태 (PENDING, APPROVED, REJECTED)',
    ...
    constraint username_unique
        unique (username),
    check (`role` in (_utf8mb4\'SUPER_ADMIN\',_utf8mb4\'ADMIN\',_utf8mb4\'CONSULTANT\',_utf8mb4\'USER\',_utf8mb4\'VISITOR\')),
	check (`status` in (_utf8mb4\'ACTIVE\',_utf8mb4\'INACTIVE\',_utf8mb4\'DELETED\',_utf8mb4\'PASSWORD_CHANGE_REQUIRED\')),
	check (`approval_status` in (_utf8mb4\'PENDING\',_utf8mb4\'APPROVED\',_utf8mb4\'REJECTED\'))
)
comment '사용자 정보';
...
(
    ...
    check (`action` in (_utf8mb4\'CREATE\',_utf8mb4\'UPDATE\',_utf8mb4\'DELETE\'))
)
comment '로그인 허용 IP 변경 이력';

create table lh_cs__notifications
(
...
create table lh_cs__question_answers
(
