...
import { useCreateNotice } from '@/shared/api/hooks/notice-hooks';
...
interface CreateBoardContentBoxProps {
  handleUndoPage: () => void;
}
...
const CreateBoardContentBox = ({
  handleUndoPage,
}: CreateBoardContentBoxProps) => {
  ...
  const handleSubmit = async () => {
    ...
    // return;
    // Mutation 실행
    createNotice(newFormData, {
      onSuccess: (data) => {
        toast.showSuccess('공지사항이 등록되었습니다.');
        console.log('생성된 공지사항:', data);
...
export default CreateBoardContentBox;
